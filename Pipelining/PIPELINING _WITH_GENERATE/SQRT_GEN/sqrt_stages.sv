...
#(
  ...
  always_ff@(posedge clk)
  begin
    $display("Time: %0t |x: %0d   |result_in: %0d   |current_bit_in: %0d   |x_out: %0d   |result_out: %0d   |current_bit_out: %0d, |temp: %0d, |x>=temp=%b, |data_valid_in: %0d  ", 
    $time, x, result_in, current_bit_in, x_out, result_out, current_bit_out,temp,(x >= temp), data_valid_in);
